...
const char* ssid     = "JO.ONLINE (BACCU)";   //WIFI SSID
const char* password = "sheuly22";   //WIFI password
String token = "1905768714:AAHt9DdPIVp6DcETYoHXe7659lzsggI1g-c";
String chat_id = "1907551388";
